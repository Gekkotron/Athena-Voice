//! End-to-end ENGLISH skill dispatch session: the smoke skill answers in the session's language.
//!
...
//! final English transcript, and asserts:
//!
...
async fn english_session_answers_in_english() {
    ...
    registry
        .install(SKILL_NAME, plugin, &["en".into()])
